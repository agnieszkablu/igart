...
/**
 * igart functions and definitions
 *
...
if (!function_exists('igart_setup')) :
   ...
   */
  function igart_setup()
  {
    /*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on igart, use a find and replace
		 * to change 'igart' to the name of your theme in all the template files.
		 */
    load_theme_textdomain('igart', get_template_directory() . '/languages');
...
add_action('after_setup_theme', 'igart_setup');
 ...
 */
function igart_content_width()
{
  // This variable is intended to be overruled from themes.
  // Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
  // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
  $GLOBALS['content_width'] = apply_filters('igart_content_width', 1140);
}
add_action('after_setup_theme', 'igart_content_width', 0);
 ...
 */
function igart_widgets_init()
{
  register_sidebar(
    array(
      'name'          => esc_html__('Sidebar', 'igart'),
      'id'            => 'sidebar-1',
      'description'   => esc_html__('Add widgets here.', 'igart'),
...
add_action('widgets_init', 'igart_widgets_init');
...
add_action('wp_enqueue_scripts', 'igart_scripts');
